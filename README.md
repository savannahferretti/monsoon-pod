...
We gratefully acknowledge support from various funding sources. S.L.F. was primarily supported by [LEAP NSF-STC](https://leap.columbia.edu/). S.L.F., M.S.P., and L.P. received funding from the DOE's [ASCR](https://www.energy.gov/science/ascr/advanced-scientific-computing-research) and [RGMA](https://eesm.science.energy.gov/program-area/regional-global-model-analysis) Programs. M.S.P and L.P. were additionally supported by the [Exascale Computing Project](https://www.exascaleproject.org/), a collaborative effort of the DOE and NNSA. F.A. was supported by the [NSF](https://www.nsf.gov/), and J.W.B. by the NASA [ECIP-ES](https://science.nasa.gov/earth-science/early-career-opportunities/#h-early-career-investigator-program-in-earth-science). Computational resources were provided by PSC's [Bridges-2](https://www.psc.edu/resources/bridges-2/) and NERSC's [Perlmutter](https://docs.nersc.gov/systems/perlmutter/architecture/). Additionally, we thank Quentin Nicolas, William R. Boos, and Nana Liu for their valuable input in shaping the early stages of this work.
